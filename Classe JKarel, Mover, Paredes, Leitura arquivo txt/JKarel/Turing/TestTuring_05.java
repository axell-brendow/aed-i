...
public class TestTuring_05 extends Turing
{
  public TestTuring_05 ( int x, int y, int dir, int beepers )
  {
      super ( x, y, dir, beepers );
  } // end constructor

  public TestTuring_05 ( int x, int y, int dir, int beepers, int color )
  {
      super ( x, y, dir, beepers, color );
  } // end constructor
  ...
  public void rule ( int state, int symbol )
  {
    ...
    rule [3*4+0][4] = 5    ;  rule [3*4+1][4] = 5    ;  rule [3*4+2][4] = STOP ;  rule [3*4+3][4] = STOP ;
    ...
    rule [4*4+0][4] = 5    ;  rule [4*4+1][4] = 6    ;  rule [4*4+2][4] = STOP ;  rule [4*4+3][4] = STOP ;
 ...
 // execute
  ...
  public static void main ( String [] args )
  {
   ...
   // define robots
      TestTuring_05 jk = new TestTuring_05 ( 1, 6, World.NORTH, 4 );

   // actions

   // System.out.println ( "[TestTuring_05]: Report" );
      jk.rule ( 0 );

   // System.out.println ( "[TestTuring_05]: Save e read the world" );
      World.saveWorld ("now.txt");
      World.reset( );
      World.readWorld ("now.txt");

  } // end main ( )
} // end TestTuring_05 class
