...
public class TestTuring_07 extends Turing
{
  public TestTuring_07 ( int x, int y, int dir, int beepers )
  {
      super ( x, y, dir, beepers );
  } // end constructor

  public TestTuring_07 ( int x, int y, int dir, int beepers, int color )
  {
      super ( x, y, dir, beepers, color );
  } // end constructor
  ...
  public void rule ( int state, int symbol )
  {
    ...
    rule [4*4+0][4] = 6    ;  rule [4*4+1][4] = 5    ;  rule [4*4+2][4] = STOP ;  rule [4*4+3][4] = STOP ;
 ...
 // execute
  ...
  public static void main ( String [] args )
  {
   ...
   // define robots
      TestTuring_07 jk = new TestTuring_07 ( 1, 6, World.NORTH, 4 );

   // actions

   // System.out.println ( "[TestTuring_07]: Report" );
      jk.rule ( 0 );

   // System.out.println ( "[TestTuring_07]: Save e read the world" );
      World.saveWorld ("now.txt");
      World.reset( );
      World.readWorld ("now.txt");

  } // end main ( )
} // end TestTuring_07 class
