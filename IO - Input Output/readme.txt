...
2.) Testar o pacote IO na pasta de instalação do Java.
    ...
    A saída prevista será a indicada abaixo (0.X = versão)
...
4.) Copiar as pastas com a documentação e os testes para 
    JAVAHOME\docs.

5.) Providências a serem tomadas em caso de erro 
    com a localização da classe IO:

    5.1.) Localizar a instalação atual do ambiente Java (jre) ativo
          (poderá existir mais de um, por exemplo, jre7)

    5.2.) Criar uma variável de ambiente:
    ...
    5.3.) Localizar a variável de ambiente PATH e 
