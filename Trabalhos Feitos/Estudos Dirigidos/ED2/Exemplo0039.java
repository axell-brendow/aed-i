...
PUC Minas - Ciencia da Computacao     Nome: Exemplo0039
...
public class Exemplo0039
{
    ...
    public static void main(String[] args)
    {
        ...
        IO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0039");
        ...
        for (int i = 0; i < numberOfProcesses; i++)
        {
            ...
            */
            ...
            // checa se o primeiro e o segundo valor nao estao no intervalo [-15, 35] e sao pares
            else if (
                    !isOnInterval(value1) && checkRestOfDivisionByTwo(value1, 0) &&
                    !isOnInterval(value2) && checkRestOfDivisionByTwo(value2, 0)
                    )
            {
                IO.println("O valor " + value1 + " e o valor " + value2 + " nao estao no intervalo [-15, 35] e sao pares\n");
            }
        }
