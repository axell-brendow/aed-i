...
PUC Minas - Ciencia da Computacao     Nome: Exemplo0040
...
public class Exemplo0040
{
    ...
    public static void main(String[] args)
    {
        ...
        IO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0040");
        ...
        for (int i = 0; i < numberOfProcesses; i++)
        {
            ...
            */
            ...
            // nao sao pares e nao sao negativos
            else if (
                    !isOnInterval(value1) && !checkRestOfDivisionByTwo(value1, 0) && !(value1 < 0) &&
                    !isOnInterval(value2) && !checkRestOfDivisionByTwo(value2, 0) && !(value2 < 0)
                    )
            {
                IO.println(value1 + " e " + value2 + " nao estao no intervalo [-15, 35], nao sao pares e nao sao negativos\n");
            }
        }
