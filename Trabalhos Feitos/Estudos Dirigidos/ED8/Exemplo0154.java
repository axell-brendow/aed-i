...
PUC Minas - Ciência da Computação     Nome: Exemplo0154
...
public class Exemplo0154
{
    ...
    public static void main(String[] args)
    {
        ...
        String fileName = "Exemplo0154.txt";
        
        //Identificacao do autor
        IO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0154");
        ...
        if (array != null)
        {
            ...
            IO.println("O maior valor do arranjo e': " + getGreatestValue(array));
        }
