...
PUC Minas - Ciência da Computação     Nome: Exemplo0174
...
public class Exemplo0174
{
    ...
    public static void showSecondaryDiagonal(double[][] array, int lines)
    {
        for(int i = 0; i < lines; i++) // percorre as linha do arranjo 2D
        {
            // mostra o elemento na coluna "maior indice de linha - linha atual"
            AxellIO.print(array[i][lines - 1 - i] + " ");
        }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0174");
        ...
        showSecondaryDiagonal(array, getFileLines(fileName));
