...
public class AxellIO
{
    ...
    /**
     * Percorre um matriz de caracteres checando a existencia de algum pre' determinado
     * @param c caractere a se procurar
     * @param matrix matriz de caracteres a percorrer
     * @return true se o caractere existir na matriz e false caso nao exista
     */
    
    public static boolean contains(char c, char[] matrix)
    {
        boolean contains = false;
        int counter = 0;

        while (!contains && counter < matrix.length)
        {
            contains = matrix[counter] == c;
