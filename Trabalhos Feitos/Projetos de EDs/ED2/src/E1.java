    ...
    public static void main(String[] args)
    {
        ...
        for (int i = 0; i < numberOfProcesses; i++)
        {
            ...
            */
            ...
            // e se o segundo e' maior que o primeiro
            else if (isOnInterval(value1) && isOnInterval(value2) && value2 > value1)
            {
                IO.println(value1 + " e " + value2 + " estao no intervalo [-15, 35] e o segundo e' maior que o primeiro\n");
            }
        }
