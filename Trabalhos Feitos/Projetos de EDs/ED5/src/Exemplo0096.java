...
PUC Minas - Ciência da Computação     Nome: Exemplo0096
...
public class Exemplo0096
{
    ...
    public static int getSum(int number)
    {
        ...
        for (int i = 0; i < number; i++) // percorre a quantidade de numeros a somar
        {
            ...
            multiple = 2 * factor; // pega o par nao multiplo de 3
            
            sum += multiple; // soma-o aos outros
            
            // achei interessante ir mostrando os multiplos para que o usuario
            // possa conferir a soma deles
            IO.println((i + 1) + "o multiplo: " + multiple);
    ...
    public static void main(String[] args)
    {
        ...
        IO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0096");
        IO.println("Autor: Axell Brendow                  Versao:  1.0\n");
        
        do
        {
            numberOfMultiples = IO.readint("Informe a quantidade dos pares nao multiplos de 3: ");
            IO.println();
