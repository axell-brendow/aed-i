...
PUC Minas - Ciência da Computação     Nome: Exemplo0138
...
public class Exemplo0138
{
    ...
    {
        FILE file = new FILE(FILE.OUTPUT, "Exemplo0138.txt");
    ...
    */
    ...
    public static long getFibonnaciTerm(int position)
    {
        ...
        if (position < 3) // para as posicoes 1 e 2 o termo e' 1
        {
            ...
            {
                data += (fibonacciSequence[position - 1] = 1L) + " ";
            }
        ...
        else
        {
            if (!existTerm(position)) // se nao existe o termo na array, adiciona-o
            {
                data += (fibonacciSequence[position - 1] = getFibonnaciTerm(position - 2) + getFibonnaciTerm(position - 1)) + " ";
            }
    ...
    public static long getFibonacciPairNumber(int pairsToRun)
    {
        ...
        pairTerm = fibonacciSequence[count - 2]; // pega o ultimo termo percorrido
    ...
    public static void main(String[] args)
    {
        ...
        long pairTerm; // termo par desejado
        
        //Identificacao do autor
        IO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0138");
        ...
        pairTerm = getFibonacciPairNumber(pairsToRun);
        
        data +=  "-> " + pairsToRun + "o termo par: " + pairTerm;
