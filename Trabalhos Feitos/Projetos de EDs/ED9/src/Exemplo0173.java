...
PUC Minas - Ciência da Computação     Nome: Exemplo0173
...
public class Exemplo0173
{
    ...
    public static void showMainDiagonal(double[][] array, int lines)
    {
        for(int i = 0; i < lines; i++) // percorre as linha do arranjo 2D
        {
            // mostra o elemento na coluna com indice igual ao da linha
            AxellIO.print(array[i][i] + " ");
        }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0173");
        ...
        showMainDiagonal(array, getFileLines(fileName));
