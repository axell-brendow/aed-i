...
PUC Minas - Ciência da Computação     Nome: Exemplo0175
...
public class Exemplo0175
{
    ...
    public static void showBelowMainDiagonal(double[][] array, int lines)
    {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0175");
        ...
        showBelowMainDiagonal(array, getFileLines(fileName));
