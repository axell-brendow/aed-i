...
PUC Minas - Ciência da Computação     Nome: Exemplo0177
...
public class Exemplo0177
{
    ...
    public static void showBelowSecondaryDiagonal(double[][] array, int lines)
    {
        for (int i = 0; i < lines; i++) // percorre as colunas do arranjo 2D
        {
            // percorre as linhas abaixo do atual elemento da diagonal secundaria
            for (int j = i + 1; j < lines; j++)
            {
                // mostra cada elemento descendo
                AxellIO.print(array[j][lines - 1 - i] + " ");
            }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0177");
        AxellIO.println("Autor: Axell Brendow                  Versao:  1.0\n");
        
        double array[][] = get2DArrayFromFile(fileName);
        
        showBelowSecondaryDiagonal(array, getFileLines(fileName));
