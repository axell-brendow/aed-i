...
PUC Minas - Ciência da Computação     Nome: Exemplo0178
...
public class Exemplo0178
{
    ...
    public static void showAboveSecondaryDiagonal(double[][] array, int lines)
    {
        for (int i = 0; i < lines; i++) // percorre as colunas do arranjo 2D
        {
            // percorre as linhas acima do atual elemento da diagonal secundaria
            for (int j = i - 1; j >= 0; j--)
            {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0178");
        AxellIO.println("Autor: Axell Brendow                  Versao:  1.0\n");
        
        double array[][] = get2DArrayFromFile(fileName);
        
        showAboveSecondaryDiagonal(array, getFileLines(fileName));
