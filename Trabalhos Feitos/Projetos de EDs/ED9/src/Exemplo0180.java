...
PUC Minas - Ciência da Computação     Nome: Exemplo0180
...
public class Exemplo0180
{
    ...
    public static boolean isNullAboveMainDiagonal(double[][] array, int lines)
    {
        boolean isNull = true;
        int i = 0, j;
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        AxellIO.println("PUC Minas - Ciencia da Computacao     Nome: Exemplo0180");
        ...
        for (int i = 3; i < 5; i++)
        {
            ...
            if (isNullAboveMainDiagonal(array, getFileLines(fileName)))
            {
                AxellIO.println("\nOs elementos acima da diagonal principal sao nulos");
            }

            else
            {
                AxellIO.println("\nOs elementos acima da diagonal principal nao sao nulos");
            }
