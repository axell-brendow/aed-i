...
public class Guia0011 extends Robot {
    ...
    /**
    construtor padrao da classe Guia0011.
    * 
    ...
    */
    ...
    public void doTask()
    {
        ...
        doPartialTask(3, true); //3, 6 || direction = south
        putBeeper();
        
        doPartialTask(3, false); //3, 3 || direction = west
        putBeeper();
        
        doPartialTask(2, true); //1, 3 || direction = south
        doPartialTask(2, true); //1, 1 || direction = east
    ...
    public static void main(String[] args)
    {
        ...
        World.readWorld("Guia0011.txt"); // ler configuracao do ambiente
